...
function start_installation() {
  ...
  for i in policykit-1 policykit-1-gnome keynav yt-dlp xautolock speedcrunch fonts-arkpandora freerdp2-x11 libfreerdp-client2-2 libfreerdp2-2 libwinpr2-2; do
